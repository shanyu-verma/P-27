...
function setup() {
	...
	chain1 = new Chain(ball2.body,ground.body,50,0);
	chain2 = new Chain(ball3.body,ground.body,100,0);
	chain3 = new Chain(ball4.body,ground.body,-50,0);
	chain4 = new Chain(ball5.body,ground.body,-100,0);
